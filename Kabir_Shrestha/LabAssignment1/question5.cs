...
namespace StudentInformationSystem
{
    class Program
    {
        ...
        {
            bool exit = false;
            Console.WriteLine("------Student Detail System------");
            while (!exit)
            {    
                Console.WriteLine("1. New student");
                Console.WriteLine("2. Details of students");
                Console.WriteLine("3. Find student");
                Console.WriteLine("4. Exit");
                Console.Write("Enter number which you want to enter: ");
        ...
        static void ViewAllStudents()
        {
            if (students.Count == 0)
            {
                Console.WriteLine("No students records found");
                return;
            }
